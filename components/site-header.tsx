          ...
          <nav className="flex items-center space-x-6 text-sm font-medium mr-4">
            {lang === "zh" ? (
               <>
                 ...
                 <Link href="/zh/skills" className="transition-colors hover:text-gray-800/80 text-gray-600 dark:text-gray-300 dark:hover:text-gray-100">
                   智能体技能 (Skills)
                 </Link>
               </>
            ) : lang === "ko" ? (
                ...
                <>
                  ...
                  <Link href="/en/skills" className="transition-colors hover:text-gray-800/80 text-gray-600 dark:text-gray-300 dark:hover:text-gray-100">
                    Skills
                  </Link>
                </>
            )}
