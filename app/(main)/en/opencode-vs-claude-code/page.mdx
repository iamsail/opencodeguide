...
### 3. Integration Depth
Both tools support the [Model Context Protocol (MCP)](/en/mcp), but OpenCode's [CLI Commands](/en/cli-commands) expose lower-level system access. OpenCode can effectively "script" your OS, whereas Claude Code generally stays within the bounds of software engineering tasks.
