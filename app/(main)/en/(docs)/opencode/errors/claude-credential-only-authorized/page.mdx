export const metadata = {
  ...
  keywords: ["opencode claude credential error", "this credential is only authorized for use with claude code", "opencode anthropic auth"],
  alternates: {
    canonical: '/en/opencode/errors/claude-credential-only-authorized',
  },
}
