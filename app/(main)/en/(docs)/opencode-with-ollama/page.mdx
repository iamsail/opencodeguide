export const metadata = {
  ...
  alternates: {
    canonical: '/en/opencode-with-ollama',
    languages: {
      'zh-CN': '/zh/docs/providers',
    },
  },
}
...
Check out **[General Use Cases](/en/use-cases)** or **[MCP Use Cases](/en/opencode-mcp-use-cases)** for more inspiration.
