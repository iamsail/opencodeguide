...
export default function Home() {
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="w-full py-24 lg:py-32 flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex gap-4">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-md bg-gray-900 px-8 py-3 text-sm font-medium text-white transition-colors hover:bg-gray-700 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-200"
          >
            Get Started
      ...
      {/* Feature Grid */}
      <section className="w-full py-20 bg-gray-50 dark:bg-gray-900 border-t border-b border-gray-100 dark:border-gray-800">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
              <div className="h-10 w-10 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center mb-4">
                <Terminal className="h-5 w-5 text-gray-700 dark:text-gray-200" />
              </div>
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">CLI First</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
              <div className="h-10 w-10 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center mb-4">
                <Cpu className="h-5 w-5 text-gray-700 dark:text-gray-200" />
              </div>
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">Local Models</h3>
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
            ...
            <Link href="/en/mcp" className="block bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm transition-shadow hover:shadow-md">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">MCP Ready</h3>
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
      ...
      <section className="w-full py-24 px-4 container max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight mb-4 text-gray-900 dark:text-gray-50">Why OpenCode?</h2>
        ...
        <div className="border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
          <div className="grid grid-cols-3 bg-gray-50 dark:bg-gray-800 p-4 font-medium text-sm text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-800">
            <div>Feature</div>
            <div>OpenCode</div>
            <div>Claude Code</div>
          </div>
          <div className="divide-y divide-gray-200 dark:divide-gray-800 text-sm">
            <div className="grid grid-cols-3 p-4 items-center">
              <div className="font-medium text-gray-900 dark:text-gray-50">Execution Environment</div>
              <div className="text-gray-700 dark:text-gray-300">Local (Your Machine)</div>
              <div className="text-gray-500 dark:text-gray-400">Cloud / SaaS</div>
            </div>
             <div className="grid grid-cols-3 p-4 items-center">
              <div className="font-medium text-gray-900 dark:text-gray-50">Model Support</div>
              <div className="text-gray-700 dark:text-gray-300">Any (Ollama, OpenAI, Anthropic, etc)</div>
              <div className="text-gray-500 dark:text-gray-400">Anthropic Only</div>
            </div>
             <div className="grid grid-cols-3 p-4 items-center">
              <div className="font-medium text-gray-900 dark:text-gray-50">Plugin System</div>
              <div className="text-gray-700 dark:text-gray-300">Open Ecosystem (npm)</div>
              <div className="text-gray-500 dark:text-gray-400">Controlled</div>
            </div>
             <div className="grid grid-cols-3 p-4 items-center">
              <div className="font-medium text-gray-900 dark:text-gray-50">Cost</div>
              <div className="text-gray-700 dark:text-gray-300">Free (Open Source)</div>
              <div className="text-gray-500 dark:text-gray-400">Usage-based Pricing</div>
            </div>
          </div>
        </div>
      </section>
