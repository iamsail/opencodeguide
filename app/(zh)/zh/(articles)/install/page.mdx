...
<table><thead><tr><th>安装方式</th><th>适合人群</th><th>是否需要 Node.js</th></tr></thead><tbody><tr><td>Desktop App</td><td>普通用户 / 非开发者</td><td>❌</td></tr><tr><td>curl 一行命令</td><td>macOS / Linux 用户</td><td>❌</td></tr><tr><td>Homebrew / paru</td><td>熟悉系统包管理器的用户</td><td>❌</td></tr><tr><td>npm / bun</td><td>前端 / Node.js 开发者</td><td>✅</td></tr></tbody></table>
